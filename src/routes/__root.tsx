  ...
  head: () => ({
    meta: [
      ...
      { title: "Eurobit — Waterproofing & Construction Chemicals, Pakistan" },
      {
        name: "description",
        content:
          "ISO 9001:2015 certified manufacturer of bitumen membranes, admixtures and protective coatings — supplied across Pakistan, trusted by Nestlé, Coca-Cola, Toyota and Lahore Airport.",
      },
      ...
      { name: "twitter:title", content: "Eurobit — Waterproofing & Construction Chemicals, Pakistan" },
      { name: "twitter:description", content: "ISO 9001:2015 certified manufacturer of bitumen membranes, admixtures and protective coatings — supplied across Pakistan, trusted by Nestlé, Coca-Cola, Toyota and Lahore Airport." },
